...
const DATA = [
  ...
  {
    ua: "Я вчора не могла подзвонити тобі.",
  ...
  {
    ua: "Я колись їв багато овочів. (раніше, але вже ні)",
...
function uaAnswerFromSource(sentence) {
  ...
  for (const tok of tokens) {
    ...
    if (word) {
      out.push(
        atSentenceStart && !UA_PROPER.has(word)
